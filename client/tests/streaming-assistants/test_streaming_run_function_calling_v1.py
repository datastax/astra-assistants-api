...
def test_function_calling_gpt_4o(streaming_assistants_openai_client):
    model="gpt-4o"
...
def test_function_calling_claude(streaming_assistants_openai_client):
...
def test_function_calling_llama(streaming_assistants_openai_client):
