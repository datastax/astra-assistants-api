...
class ThreadObjectToolResources(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ThreadObjectToolResources from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ThreadObjectToolResources from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "file_search": ThreadObjectToolResourcesFileSearch.from_dict(obj.get("file_search")) if obj.get("file_search") is not None else None
        })
        return _obj
