...
class ModifyThreadRequest(BaseModel):
    ...
    ModifyThreadRequest
    """ # noqa: E501
    tool_resources: Optional[ThreadObjectToolResources] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "tool_resources": ThreadObjectToolResources.from_dict(obj.get("tool_resources")) if obj.get("tool_resources") is not None else None,
