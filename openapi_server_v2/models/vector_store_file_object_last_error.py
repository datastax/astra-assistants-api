...
class VectorStoreFileObjectLastError(BaseModel):
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('internal_error', 'file_not_found', 'parsing_error', 'unhandled_mime_type'):
            raise ValueError("must be one of enum values ('internal_error', 'file_not_found', 'parsing_error', 'unhandled_mime_type')")
        return value
