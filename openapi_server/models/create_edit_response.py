...
class CreateEditResponse(BaseModel):
    ...
    CreateEditResponse
    """ # noqa: E501
    choices: Optional[List[CreateEditResponseChoicesInner]] = Field(default=None, description="A list of edit choices. Can be more than one if `n` is greater than 1.")
