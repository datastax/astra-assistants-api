...
class CreateChatCompletionResponseChoicesInnerLogprobs(BaseModel):
    ...
    CreateChatCompletionResponseChoicesInnerLogprobs - a model defined in OpenAPI
        ...
        content: The content of this CreateChatCompletionResponseChoicesInnerLogprobs.
    """

    content: List[ChatCompletionTokenLogprob] = Field(alias="content")

CreateChatCompletionResponseChoicesInnerLogprobs.update_forward_refs()
