...
class CreateEditResponseChoicesInner(BaseModel):
    ...
    """ # noqa: E501
    finish_reason: StrictStr = Field(description="completion_finish_reason_description")
    index: StrictInt = Field(description="The index of the choice in the list of choices.")
    text: StrictStr = Field(description="The edited result.")
    __properties: ClassVar[List[str]] = ["finish_reason", "index", "text"]
