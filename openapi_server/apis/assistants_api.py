...
,
    limit: int = Query(20, description="pagination_limit_param_description")
,
    order: str = Query('desc', description="pagination_order_param_description")
,
    after: str = Query(None, description="pagination_after_param_description")
,
